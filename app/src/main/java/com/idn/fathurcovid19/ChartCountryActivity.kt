...
import com.idn.fathurcovid19.network.InfoCountry
import com.idn.fathurcovid19.network.InfoService
...
class ChartCountryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txt_total_recovered_current.text = totalRecovered.toString()
