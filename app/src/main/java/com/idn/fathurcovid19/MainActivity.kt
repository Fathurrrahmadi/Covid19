...
import com.idn.fathurcovid19.network.APIService
import com.idn.fathurcovid19.network.AllCountries
import com.idn.fathurcovid19.network.Countries
import com.idn.fathurcovid19.network.CountryAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getCountry() {
        ...
        api.getAllCountries().enqueue(object : retrofit2.Callback<AllCountries> {

            override fun onResponse(
                call: retrofit2.Call<AllCountries>, response: retrofit2.Response<AllCountries>
            ) {
                if (response.isSuccessful) {
                    ...
                    rv_country.apply {
                        ...
                        countryAdapter =
                            CountryAdapter(response.body()?.Countries as ArrayList<Countries>) {
                                itemClikcked(it)
                            }
            ...
            override fun onFailure(call: retrofit2.Call<AllCountries>, t: Throwable) {
    ...
    private fun itemClikcked(country: Countries) {
